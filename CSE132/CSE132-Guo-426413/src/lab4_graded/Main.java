...
//	public Main() {
//		String[]
//		       places = { "library", "gym", "dorm", "home", "blueberry hill", "dance club", "store", "spa", "dorm", "Canada" },
//		       names  = { "studiousmaximus", "alice", "bob", "charlie", "diane", "Beyonce", "Arnold", "Joe", "Steve", "Mark" };
//
//		rand = new Random();
//		
//		model = new Weasley();
